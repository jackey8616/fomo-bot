...
def serious_summarize_with_link(messages: list[Message]) -> tuple[list[str], str]:
    system_instructions = [
        ...
        "The chat log will be provided within the <chat_log> tags.",
        "Each message in the log will include the `time`, `author`, `content`, and a `jump_url` which links directly to that message on Discord.",
        "Like this: `[2025-05-04 12:00:00] User A: Hello, how are you? (link_to:1234567890)`",
        "",
        ...
        "    *   Format each bullet point as: `* [Concise summary of the point][Ref](link_to:1234567890)`.",
        ...
        "*   關於某個概念的學習點[Ref](link_to:1234567890)",
        "*   分享的另一個見解[Ref](link_to:1234567890)",
        "",
        "**分享的資源 (Shared Resources):**",
        "*   某個工具的連結[Ref](link_to:1234567890) - 簡短描述",
        "*   提到的函式庫[Ref](link_to:1234567890) - 使用情境",
        "",
        "**快速協助/建議 (Quick Help/Advice):**",
        "*   用戶A 在 問題 上獲得 用戶B 的幫助 - 簡要解決方案[Ref](link_to:1234567890)",
        "*   提出的問題 得到 回答[Ref](link_to:1234567890)",
        "",
        "**專案更新/討論 (Project Updates/Discussions):**",
        "*   用戶C 分享了 專案名稱 的進度 - 簡要更新[Ref](link_to:1234567890)",
        "*   關於 專案想法 的討論 [Ref](link_to:1234567890)",
        "",
        "**閒聊/八卦 (Casual Chat/Gossip):**",
        "*   用戶D 分享了週末計畫[Ref](link_to:1234567890)",
        "*   關於 [某個非技術話題] 的輕鬆討論[Ref](link_to:1234567890)",
        "*   社群成員互相問候或開玩笑[Ref](link_to:1234567890)",
        "",
    ]
    raw_messages = ""
    for message in messages:
